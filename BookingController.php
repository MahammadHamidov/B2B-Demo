...
$messages['first_name.required'] = __('Zəhmət olmasa Ad hissəsini doldurun');
$messages['last_name.required'] = __('Zəhmət olmasa Soyad hissəsini doldurun');
$messages['email.required'] = __('Zəhmət olmasa Cinsiyyət hissəsini doldurun');
$messages['phone.required'] = __('Zəhmət olmasa Telefon nömrənizi daxil edin');
$messages['term_conditions.required'] = __('Zəhmət olmasa ödəniş növünü seçin');
